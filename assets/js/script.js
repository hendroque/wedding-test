let tanggalPernikahan = new Date("Mar 15, 2025 08:00:00").getTime();
...
var myfunc = setInterval(function () {
  ...
  if (timeleft < 0) {
    ...
    if (timeleft * -1 + tanggalPernikahan < tanggalPernikahan + 1000 * 60 * 60 * 24) {
      console.log(timeleft * -1 + tanggalPernikahan, tanggalPernikahan + 60 * 60 * 24);
    } else {
