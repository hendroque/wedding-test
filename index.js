...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVsZGZnc2Vicm14dHR0bGdkcWl0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzAxOTkyOTksImV4cCI6MTk4NTc3NTI5OX0.85GidDshJWbU3Kg3CL6D4Kdy2omSa8vVBF6h71Qyv4A";
...
app.get("/komentar", async (req, res) => {
  let { data: komentar, error } = await supabase.from("komentar").select("*").order("id", { ascending: true });
  res.json(komentar);
});
